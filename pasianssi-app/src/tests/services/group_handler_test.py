...
class TestGroupHandler(unittest.TestCase):
    ...
    def test_palauttaa_kortin_ryhman(self):
        self.assertEqual(self.group_handler.get_current_group(
            self.card), self.card_group)

    def test_jos_korttia_ei_loydy_palauttaa_none(self):
        self.assertIsNone(
            self.group_handler.get_current_group(self.card3))
    ...
    def test_tyhjentaa_kaikki_ryhmat(self):
        ...
        self.group_handler.clear_card_groups()
